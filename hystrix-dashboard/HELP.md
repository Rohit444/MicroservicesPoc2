...
* The original package name 'com.java.microservicedemo.api.gateway.hystrix-dashboard' is invalid and this project uses 'com.java.microservicedemo.api.gateway.hystrixdashboard' instead.
